...
<script>
  ...
  methods: {
    ...
    getGridData() {
      ...
      var res = Object.toAjaxJson(FUI.Handlers.WorkflowBusinessHandler, 'getDoneList', parm, true, null, function (res) {
        if (res.success) {
    ...
    excelExportClick() { 
      ...
      Object.toAjaxDownloadFile('/workflow/workflowExport/', 'exportDone', parm);
    },
